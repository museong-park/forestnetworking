...
const categories = [
  {
    ...
    projects: [
      {
        name: "시골언니프로젝트 (1기: 08.18~23 / 2기: 09.08~13)",
        ...
        images: [{ src: "/4.프로젝트/exploration_1_v2.jpg", alt: "탐색 경험 – 마을·공동체 체험" }],
      },
      {
        ...
        images: [{ src: "/4.프로젝트/exploration_2_v2.jpg", alt: "탐색 경험 – 핸즈온 워크숍" }],
      },
    ],
  },
  {
    ...
    projects: [
      {
        name: "세계식물원교육총회(ICEBG) 식물 교육 워크숍 (06.12)",
        desc: "황둔중학교 학생들이 세계식물원교육총회(ICEBG)에 참여하여 국내외 식물교육 사례를 공유하고 청소년 주도 식물교육 모델을 소개하는 워크숍을 운영. 국제 교육 현장과의 교류를 통해 학교 기반 식물교육의 확장 가능성 탐색.",
        images: [{ src: "/4.프로젝트/value_0_v2.jpg", alt: "세계식물원교육총회(ICEBG) 식물 교육 워크숍" }],
      },
      {
        name: "동화마을수목원 가을축제 (10.25)",
        desc: "체험·교육·놀이·공연 등 온가족이 함께 즐길 수 있는 프로그램을 통해 산림문화복지 서비스를 제공하고 산림의 공익적 가치를 공유하는 '2025 동화마을수목원 가을축제' 용역 수행.",
        images: [{ src: "/4.프로젝트/value_1_v2.jpg", alt: "동화마을수목원 가을축제 – 가족 체험 활동" }],
      },
      {
    ...
    projects: [
      {
        ...
        images: [{ src: "/4.프로젝트/sustainability_1_v2.jpg", alt: "가평 조항마을 – 국유림 화백숲 체험" }],
      },
      {
        ...
        images: [{
          src: "/4.프로젝트/sustainability_2_v2.jpg", alt: "여주 주어리마을 – 지역 연계 사업"
        }],
      },
      {
        ...
        images: [{ src: "/4.프로젝트/sustainability_4_v2.jpg", alt: "양평 수미마을 – 청년 임업·가공 기반" }],
      },
    ],
  },
  {
    ...
    projects: [
      {
        ...
        images: [{ src: "/4.프로젝트/regeneration_1_v2.jpg", alt: "브랜드 온림 – 산불피해목 활용 제품" }, { src: "/4.프로젝트/regeneration_2_v2.jpg", alt: "브랜드 온림 – 산불피해목 활용 제품" }],
      },
    ],
  },
];
...
const chronologicalProjects: { date: string; description: string }[] = [
  { date: "2020. 03.", description: "산학연관협력 지역관광 프로젝트 ‘3Go_산촌Go, 감성Go, 맛Go’ (한국관광공사)" },
  { date: "2020. 08.", description: "지역상생형 산림특화 사회적경제 모델 수립 (한국임업진흥원)" },
  { date: "2020. 10.", description: "골든포레스트페스티벌 운영" },
  { date: "2020. 12.", description: "선도산림경영단지 6차산업모델 연구 (춘천시)" },
  { date: "2021. 03.", description: "지역순환형 임업을 위한 경영주체 현황 및 실태조사 (국립산림과학원)" },
  { date: "2021. 03.", description: "지역상생형 산림특화 사회적경제 모델 수립 (한국임업진흥원)" },
  { date: "2021. 04.", description: "강원 어촌마을 현황 조사 (강원귀어귀촌지원센터)" },
  { date: "2021. 04.", description: "귀산촌 스타트업 교육기관 선정 (한국임업진흥원)" },
  { date: "2021. 04.", description: "문화자원 개발 및 활성화사업 ‘36.5도시프로젝트’ 운영 (원주시창의문화도시지원센터)" },
  { date: "2021. 05.", description: "경북어촌특화지원센터 자원조사 및 DB구축 (재단법인 환동해산업연구원)" },
  { date: "2021. 05.", description: "원주, 삼척 관광두레 주민사업체의 사업화 관리 (한국관광공사)" },
  { date: "2021. 05.", description: "제12회 예비·초기관광벤처사업 선정 (한국관광공사)" },
  { date: "2021. 09.", description: "농어촌상생기금활용 팸투어 프로그램 운영 (대중소기업 농어업협력재단)" },
  { date: "2022. 05.", description: "제13회 성장 관광벤처사업 선정 (한국관광공사)" },
  ...
  { date: "2022. 07.", description: "평창홍보영상 제작 및 스마트 스크린 운영 관리 (한국관광공사)" },
  { date: "2022. 08.", description: "횡성 청일 선도산림경영단지 융복합 모델 연구 (횡성군)" },
  { date: "2022. 09.", description: "농어촌상생기금활용 팸투어 프로그램 운영 (대·중소기업 농어업협력재단)" },
  { date: "2022. 09.", description: "설악산 국립공원 친환경여행 캠페인 (한국관광공사)" },
  { date: "2022. 09.", description: "2022 대한민국 독서대전 평가 (원주시평생교육원 시립중앙도서관)" },
  { date: "2023. 03.", description: "인제군 진동계곡마을 활성화사업 주민역량강화 (인제군농업기술센터)" },
  { date: "2023. 03.", description: "여성농업인 영농여건 개선 교육기관 선정 (농림수산식품교육문화정보원)" },
  { date: "2023. 05.", description: "인구소멸위기지역 찾아가는 청소년산림교육 (산림청)" },
  { date: "2023. 05.", description: "2023 시골언니 프로젝트 운영 (농림수산식품교육문화정보원)" },
  { date: "2023. 07.", description: "국가숲길, 명품숲길 50 홍보 (산림청)" },
  { date: "2023. 09.", description: "둔내면 도시재생대학 운영 (횡성군)" },
  { date: "2024. 02.", description: "목재문화체험장 타당성 조사 (원주시)" },
  { date: "2024. 05.", description: "2024 시골언니 프로젝트 운영 (농림수산식품교육문화정보원)" },
  { date: "2025. 05.", description: "2025 시골언니 프로젝트 운영 (농림수산식품교육문화정보원)" },
  { date: "2025. 05.", description: "2025년 산촌활력 특화사업 (1차년도 : 가평, 여주 / 2차년도 : 횡성, 양평) 운영 (한국임업진흥원)" },
  { date: "2025. 05.", description: "BETTER里 인구감소지역 관광인구 증대 사업 선정" },
  { date: "2025. 05.", description: "빛나라! 경기강원 스타상품발굴 프로젝트 선정" },
  { date: "2025. 06.", description: "세계식물원교육총회(ICEBG) 식물 교육 워크숍 운영" },
  { date: "2025. 06.", description: "인제 용대1리 마을회 야영장 체험 프로그램 개발, 국밥 레시피 개발 (5대명품 로컬푸드 협동조합)" },
  { date: "2025. 10.", description: "제3회 동화마을 수목원 가을 축제 운영 (원주시)" },
  { date: "2025. 11.", description: "동서트레일 거점마을 연계 사업화 모델 연구 (산림청)" },
  { date: "2025. 11.", description: "공모전 수상작 교구 제작 및 배포 (목재문화진흥회)" },
  { date: "2025. 12.", description: "2025 산림복지 목재 인테리어 지원 사업 (목재문화진흥회)" },
  { date: "2025. 12.", description: "영월 녹전중학교 청소년 푸드아트테라피 운영" },
]
